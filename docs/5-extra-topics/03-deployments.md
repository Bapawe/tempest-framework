...
# See: https://tempestphp.com/docs/getting-started/installation#scaffolding-front-end-assets
...
Next, make sure that the `.tempest` directory is writable by the web server, this is the cache directory used by Tempest. Finally, [enable the scheduler](../2-features/11-scheduling.md#using-the-scheduler).
